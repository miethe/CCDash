...
tasks:
- id: T6-001
  description: Extend no-LLM guard to worker — AST-walk routing_rollup_sweep_job.py
    transitive imports
  status: completed
  assigned_to:
  - python-backend-engineer
...
- id: T6-002
  description: Digest-parity CI test (seam task) — vendored mapping file SHA-256 ==
    MAPPING_DIGEST (AC-2)
  status: completed
  assigned_to:
  - python-backend-engineer
  ...
  completed: 2026-07-31T01:00Z
  evidence:
  - test: backend/tests/test_routing_feedback_contract_parity.py
  verified_by:
  - T6-007
- id: T6-003
  description: Envelope-completeness test (seam task) — all 11 pinned fields + 3 top-level
    counters (AC-1)
  status: completed
  assigned_to:
  - python-backend-engineer
  ...
  assigned_model: sonnet
  model_effort: adaptive
  started: 2026-07-31T01:00Z
  completed: 2026-07-31T01:45Z
  evidence:
  - test: backend/tests/test_routing_rollup_envelope_completeness.py
  verified_by:
  - T6-007
- id: T6-004
  ...
  - T6-007
- id: T6-005
  description: Sparse-key + protected-class fixture tests — sub-threshold visibility
    (AC-5), coverage-only handling (AC-6)
  status: completed
  assigned_to:
  - python-backend-engineer
  dependencies:
  ...
  assigned_model: sonnet
  model_effort: adaptive
  started: 2026-07-31T15:57Z
  completed: 2026-07-31T16:20Z
  evidence:
  - test: backend/tests/test_routing_rollup_sparse_protected.py
  verified_by:
  - T6-007
- id: T6-006
  description: Disabled-state + reversibility + version-field tests — all transports
    (AC-4, AC-7, AC-8)
  status: completed
  assigned_to:
  - python-backend-engineer
  ...
  assigned_model: sonnet
  model_effort: adaptive
  started: 2026-07-31T16:20Z
  completed: 2026-07-31T16:50Z
  evidence:
  - test: backend/tests/test_routing_rollup_disabled_state.py
  verified_by:
  - T6-007
- id: T6-007
  description: task-completion-validator gate — phase-end review of all tasks and
    ACs
  status: pending
  assigned_to:
  - task-completion-validator
  ...
  assigned_model: sonnet
- id: T6-008
  description: karen feature-end review — verify claimed completion against actual
    behavior across all 6 phases
  status: pending
  assigned_to:
  - karen
  dependencies:
...
- id: DOC-001
  ...
  model_effort: adaptive
  started: 2026-07-31T23:00Z
  completed: 2026-07-31T23:15Z
- id: DOC-002
  description: Consumer-contract doc — mirrors ccdash-aar-review-consumer-contract-v1.md
    structure
  status: completed
  assigned_to:
  - documentation-writer
  ...
  model_effort: adaptive
  evidence:
  - note: docs/project_plans/design-specs/ccdash-routing-feedback-consumer-contract-v1.md
- id: DOC-003
  ...
  assigned_model: haiku
  model_effort: adaptive
  started: 2026-07-31T16:50Z
  completed: 2026-07-31T17:10Z
- id: DOC-006
  description: Deferred-items design specs — DI-1 (router merge), DI-2 (model namespacing),
    DI-3 (window/decay defaults)
  status: completed
  assigned_to:
  - documentation-writer
  dependencies:
  ...
  model_effort: adaptive
  started: 2026-07-31T16:20Z
  completed: 2026-07-31T16:30Z
  evidence:
  - note: docs/project_plans/design-specs/routing-feedback-router-merge-handoff.md
  - note: docs/project_plans/design-specs/routing-feedback-model-provider-namespacing.md
  - note: docs/project_plans/design-specs/routing-feedback-window-decay-defaults.md
parallelization:
  batch_1:
  - T6-001
  - DOC-001
