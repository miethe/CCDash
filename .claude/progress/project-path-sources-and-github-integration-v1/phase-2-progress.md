...
- id: PPG-7
  ...
  priority: high
- id: PPG-8
  description: Implement repo workspace cache lifecycle and stable local workspace
    creation.
  status: completed
  assigned_to:
  - python-backend-engineer
...
blockers: []
success_criteria:
- Resolver returns concrete local paths for project_root, filesystem, and github_repo
  sources.
