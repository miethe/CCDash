...
tasks:
  ...
  - id: "P1-T3"
    ...
    dependencies: ["P1-T2"]
    effort: "M"
    files: ["backend/db/repositories/telemetry_queue.py"]
  ...
  - id: "P1-T8"
    ...
    effort: "M"
    files: ["backend/tests/test_telemetry_transformer.py"]
  ...
  - id: "P1-T9"
    ...
    dependencies: ["P1-T3"]
    effort: "M"
    files: ["backend/tests/test_telemetry_queue_repository.py"]

parallelization:
  batch_1: ["P1-T1", "P1-T2", "P1-T5"]
  batch_2: ["P1-T3", "P1-T6", "P1-T7"]
  batch_3: ["P1-T4", "P1-T8", "P1-T9"]
---
