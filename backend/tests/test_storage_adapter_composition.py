...
class StorageAdapterCompositionTests(unittest.TestCase):
    ...
    def test_local_adapter_exposes_domain_grouped_storage_views(self) -> None:
        ...
        self.assertIs(adapter.observed_product().session_embeddings(), adapter.session_embeddings())
        self.assertIs(adapter.observed_product().session_intelligence(), adapter.session_intelligence())
        ...
        self.assertIs(adapter.observed_product().feature_sessions(), adapter.feature_sessions())
        ...
        self.assertIs(adapter.integration_snapshots().artifact_snapshots(), adapter.artifact_snapshots())
