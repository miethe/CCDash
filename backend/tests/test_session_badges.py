    ...
    def test_derives_models_agents_skills_and_tools(self) -> None:
        logs = [
            ...
            },
            {
                "type": "tool",
                "tool_name": "Bash",
                "metadata_json": '{"subagentAgentId":"worker-1","subagentName":"backend-reviewer","taskSubagentType":"python-backend-engineer"}',
            },
            {
                "type": "tool",
                "tool_name": "Bash",
        ...
        self.assertEqual(badges["agentsUsed"], ["root-agent", "Planner", "worker-1", "backend-reviewer", "python-backend-engineer"])
