...
# Sentinel workspace used by callers that are not yet workspace-routing-aware.
...
class SessionRepository(Protocol):
    ...
    async def list_by_workflow_ids(self, workflow_ids: list[str], project_id: str | None = None, *, workspace_id: str = DEFAULT_WORKSPACE_ID) -> list[dict]: ...
