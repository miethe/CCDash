...
description: "Extend Planning Command Center across all configured projects with project grouping/coloring and a consolidated live active-session board."
summary: "Add a single planning operations screen that combines cross-project command-center work items, all-project active sessions, project display metadata, freshness indicators, and route-local access to relevant session, feature, plan, and execution detail."
created: 2026-05-29
updated: 2026-05-29
priority: high
risk_level: high
